...
def is_big_enough(value):
    """changes s3 links to CDN links"""
    if 'x' in value and (int(value.split(' x ')[0])>2047 or int(value.split(' x ')[1])>2047):
